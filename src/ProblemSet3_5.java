...
public class ProblemSet3_5 {
	...
	public void primes(int start, int end) {
		...
		if(primeNums > 1) {
			System.out.println("There are " + primeNums + " prime numbers.");
		}else {
			System.out.println("There is " + primeNums + " prime number.");
		}
}	
	/**
	...
	public void leapYears(int count) {
		...
		System.out.println("and " + ((count-1)*4 + firstLeap) + ".");
		}
	}
	...
	public void fibonacci(int n) {
		...
		if(n == 11 || n == 12 || n == 13 || n%100 == 13 || n%100 == 12 || n %100 == 11 || n%100 == 0) {
